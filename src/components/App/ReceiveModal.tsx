import { Button } from '@jupisky/jupisky-react-components'
  ...
  return (
    <>
      ...
      <Paragraph className={classes.networkInfo} noMargin size="lg" weight="bolder">
        {networkInfo.label} Network–only send {networkInfo.label} assets to Jupisky.
      </Paragraph>
      <Paragraph className={classes.annotation} noMargin size="lg">
        This is the address of Jupisky. Deposit funds by scanning the QR code or copying the address below. Only send{' '}
      ...
      <Row align="center" className={classes.buttonRow}>
        <Button size="md" color="secondary" onClick={onClose} variant="contained">
          Done
        </Button>
      </Row>
    </>
