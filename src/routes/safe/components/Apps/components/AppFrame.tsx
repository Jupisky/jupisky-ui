...
const APP_LOAD_ERROR = 'There was an error loading the Jupisky App. There might be a problem with the App provider.'
  ...
  if (!safeApp) {
    return (
      <LoadingContainer style={{ flexDirection: 'column' }}>
        {isLoadingSlow && (
          <Title size="xs">
            The Jupisky App is taking too long to load. There might be a problem with the App provider.
          </Title>
        )}
        <Loader size="md" />
      </LoadingContainer>
